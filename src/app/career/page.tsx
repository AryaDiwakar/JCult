        ...
        <section className="relative h-[50vh] md:h-[70vh] lg:h-[80vh] overflow-hidden mb-6 md:mb-8">
          ...
          <div className="absolute top-4 md:top-6 lg:top-8 left-0 right-0 z-10">
            <div className="container-responsive">
              <h1 className="text-white max-w-[250px] md:max-w-[400px] lg:max-w-[600px] text-2xl md:text-4xl lg:text-[64px] font-[400] leading-tight md:leading-snug lg:leading-[70px] font-lora">
                Career
              </h1>
            </div>
          </div>
            ...
            <div className="container-responsive">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="border-l-2 border-secondary pl-4 md:pl-6">
                  ...
                  <Link href="/career/open-opportunities?experience=Internship" className="text-gold font-raleway font-semibold hover:underline inline-flex items-center">
                    View Internships
                ...
                <div className="border-l-2 border-secondary pl-4 md:pl-6">
                  ...
                  <Link href="/career/open-opportunities?experience=Experienced Professionals,Graduates" className="text-gold font-raleway font-semibold hover:underline inline-flex items-center">
