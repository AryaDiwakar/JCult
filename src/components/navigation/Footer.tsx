    ...
    <footer ref={footerRef} className="bg-primary text-white py-8">
      <div className="container-responsive">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-8 mb-8">
          {/* Logo */}
          <div className={`text-xl font-bold text-gold transition-all duration-1000 ${
          ...
          <nav className="flex flex-wrap justify-center gap-4 lg:gap-6">
            {['Who We Are', 'What We Do', 'News', 'Career', 'Contact Us'].map((link, i) => (
              <a key={link} href="#" className={`hover:text-gold hover:underline text-sm transition-all duration-1000 ${
        ...
        <div className="border-t border-white/30 pt-6">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div className={`flex flex-wrap justify-center gap-4 transition-all duration-1000 delay-700 ${
              ...
              <a href="#" className="text-xs hover:text-gold hover:underline">Privacy</a>
              <a href="#" className="text-xs hover:text-gold hover:underline">Terms of Use</a>
              <a href="#" className="text-xs hover:text-gold hover:underline">Notices</a>
              <a href="#" className="text-xs hover:text-gold hover:underline">Disclosure</a>
            </div>
