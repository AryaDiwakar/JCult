      ...
      <div className="container-responsive">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-8 mb-8">
          ...
          <div className={`transition-all duration-1000 ${
            ...
            <Image 
              src="/Final Logos/Transparent/Base Logo/Secondary/Transparent Secondary.svg" 
              alt="JCULT" 
              width={120} 
              height={32}
          ...
          <div className={`flex gap-4 transition-all duration-1000 delay-1100 ${
            ...
            <a href="#" className="hover:text-gold transition-colors duration-300" aria-label="X (Twitter)">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="#" className="hover:text-gold transition-colors duration-300" aria-label="LinkedIn">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="border-t border-white/30 pt-6">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div className={`flex flex-wrap justify-center gap-4 transition-all duration-1000 delay-700 ${
              ...
              <a href="/terms-of-use" className="text-xs hover:text-gold hover:underline">Terms of Use</a>
              <a href="/notices" className="text-xs hover:text-gold hover:underline">Notices</a>
              <a href="/disclosure" className="text-xs hover:text-gold hover:underline">Disclosure</a>
            </div>
